...
export default function LandingPage() {
  ...
  return (
    <main className="landing">
      ...
      <footer><div className="container footer-grid"><div><Link href="/" className="landing-brand inverse"><span className="brand-mark"><Zap/></span> Close<span>AI</span></Link><p>L’assistant IA qui transforme vos conversations WhatsApp en ventes.</p></div><div><b>Produit</b><a href="#fonctionnalites">Fonctionnalités</a><a href="#tarifs">Tarifs</a><a href="#demo">Démonstration</a></div><div><b>Ressources</b><a href="#faq">Centre d’aide</a><a href="#">Documentation API</a><a href="#">Guide WhatsApp</a></div><div><b>Légal</b><a href="#">Confidentialité</a><a href="#">Conditions</a><a href="#">Sécurité</a></div></div><div className="container footer-bottom"><span>© 2026 CloseAI. Tous droits réservés.</span><span><i/> Tous les systèmes opérationnels</span></div></footer>
    </main>
  );
}
